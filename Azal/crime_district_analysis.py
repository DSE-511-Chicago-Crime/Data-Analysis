...
plt.savefig("Number_of_Crimes_Per_Districts_of_Chicago_city.png", dpi=300)
#plt.show()
...
plt.savefig("Crime_distribution_per_region_in_Chicago_city.png",dpi=300)
#plt.show()
...
fig.tight_layout()
plt.savefig("The_Percent_Change_of_Crimes_Per_District_in_Chicago_city.png",dpi=300)
plt.show()
